...
import illustration from "../assets/images/reset-illustration.png"; // Confirm file name/path (or use login/signup-illustration.png if same)
...
const ResetPassword: React.FC = () => {
  ...
  const onSubmit: SubmitHandler<ResetPasswordForm> = (data) => {
    // Dummy reset password logic: redirect to login if email is valid
    setSuccess(true);
